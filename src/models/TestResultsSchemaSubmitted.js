...
const testTypesSchema = Joi.object().keys({
  ...
  reasonForAbandoning: Joi.string().max(500).required().allow(null).allow(''),
  additionalNotesRecorded: Joi.string().max(500).required().allow(null).allow(''),
  additionalCommentsForAbandon: Joi.string().max(500).required().allow(null).allow(''),
...
const testResultsSchema = Joi.object().keys({
  ...
  testerStaffId: Joi.string().max(9).required().allow(''),
  ...
  reasonForCancellation: Joi.string().max(500).required().allow(null).allow('')
})
