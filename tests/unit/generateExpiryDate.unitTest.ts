  ...
  context('submitted test', () => {
    ...
    context('for hgv and trl vehicle types', () => {
      ...
      context(
        ...
        () => {
          ...
          describe('First test types', () => {
            const hgvTestResult = cloneDeep(testResults[15]) as unknown as ITestResult;
      ...
      describe('for TRL vehicles', () => {
        describe('First test types', () => {
          const trlTestResult = cloneDeep(testResults[17]) as unknown as ITestResult;
        ...
        describe('Non-First-Test Types', () => {
          const trlTestResult = cloneDeep(testResults[15]) as unknown as ITestResult;
          trlTestResult.testTypes.forEach((type) => {
            type.testTypeId = '94';
          });
          describe('with Today >2 months before previous expiry date', () => {
        ...
        context(
          ...
          () => {
            it('should set the expiry date to last day of test date month + 1 year', () => {
              const hgvTestResult = cloneDeep(testResults[16]) as unknown as ITestResult;
