...
describe('TestResultsService calling generateExpiryDate', () => {
  ...
  describe('When inserting a testResult with Annual With Certificate classification', () => {
    test.each`
      ...
      ${VEHICLE_TYPES.HGV} | ${TEST_RESULT.FTA}       | ${'122'}   | ${false}
      ...
      ${VEHICLE_TYPES.TRL} | ${TEST_RESULT.FTA}       | ${'91'}    | ${false}
      ...
      ${VEHICLE_TYPES.PSV} | ${TEST_RESULT.FTA}       | ${'1'}     | ${false}
      ...
      ${VEHICLE_TYPES.HGV} | ${TEST_RESULT.FTA}       | ${'94'}    | ${false}
      ...
      ${VEHICLE_TYPES.HGV} | ${TEST_RESULT.FTA}       | ${'50'}    | ${false}
      ...
      ${VEHICLE_TYPES.PSV} | ${TEST_RESULT.FTA}       | ${'39'}    | ${false}
    `(
